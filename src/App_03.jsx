...
const WORDS = [
  { id: 1, answer: "FAILOVER", row: 1, col: 5, dir: "across", clue: "Primary node erişilemez olunca diğer node'a geçiş işlemi." },
  { id: 2, answer: "LISTENER", row: 1, col: 8, dir: "down", clue: "Always On bağlantılarının ortak erişim noktası." },
  { id: 3, answer: "REPLICA", row: 1, col: 12, dir: "down", clue: "Always On yapısındaki kopya sunucu." },
  { id: 4, answer: "AGENT", row: 4, col: 6, dir: "down", clue: "Job ve schedule işlemlerini yöneten SQL Server servisi." },
  { id: 5, answer: "TRIGGER", row: 5, col: 3, dir: "across", clue: "INSERT, UPDATE veya DELETE sonrası otomatik çalışan yapı." },
  { id: 6, answer: "QUORUM", row: 7, col: 4, dir: "down", clue: "Cluster karar mekanizmasının oy dengesi sistemi." },
  { id: 7, answer: "CLUSTER", row: 8, col: 2, dir: "across", clue: "Yüksek erişilebilirlik sağlayan sunucu grubu." },
  { id: 8, answer: "RESTORE", row: 10, col: 4, dir: "across", clue: "Backup dosyasından geri yükleme işlemi." }
];
