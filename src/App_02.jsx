...
const WORDS = [
  { id: 1, answer: "STATISTICS", row: 2, col: 2, dir: "across", clue: "Optimizer'ın sorgu planı hazırlarken baktığı veri dağılım bilgisi." },
  { id: 2, answer: "TEMPDB", row: 2, col: 3, dir: "down", clue: "Sort, hash ve geçici işlemlerin ortak uğrak yeri." },
  { id: 3, answer: "MEMORY", row: 4, col: 3, dir: "across", clue: "SQL Server'ın en değerli çalışma alanı." },
  { id: 4, answer: "SCAN", row: 4, col: 1, dir: "down", clue: "Tüm satırları dolaşan erişim yöntemi." },
  { id: 5, answer: "MAXDOP", row: 6, col: 0, dir: "across", clue: "Parallel çalışan thread sınırını belirleyen ayar." },
  { id: 6, answer: "BUFFER", row: 7, col: 6, dir: "across", clue: "Diskten gelen sayfaların ilk tutulduğu alan." },
  { id: 7, answer: "REBUILD", row: 4, col: 7, dir: "down", clue: "Index fragmentation sonrası yapılan bakım işlemi." },
  { id: 8, answer: "INDEX", row: 10, col: 5, dir: "across", clue: "Veriye hızlı erişim sağlayan yapı." },
  { id: 9, answer: "SEEK", row: 2, col: 11, dir: "down", clue: "Index üzerinden hedefe direkt erişim yöntemi." }
];
